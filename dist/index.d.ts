...
import mongoose, { Model, Document as Document$1, PopulateOptions, FilterQuery, UpdateQuery, SchemaDefinitionProperty, Schema, CompileModelOptions } from 'mongoose';
...
type modelT<T, U> = (name: string, schema?: Schema<T, any, any> | Schema<T & Document$1, any, any>, collection?: string, options?: CompileModelOptions) => Model<T>;
/**
...
declare const generateDynamicSchema: <T, U>({ fields, modelName, plugins, schemaOptions, model }: {
    ...
    model: modelT<T & Document$1, Model<T & Document$1> & U>;
}) => {
