...
declare class CrudS {
     ...
     */
    static create<T, U>(MyModel: CrudModelI, data: T, finder: FilterQuery<U>): Promise<any>;
    /**
     ...
     */
    static createMany<T, U>(MyModel: CrudModelI, data: T[], finder: FilterQuery<U>[]): Promise<any>;
    /**
     ...
     */
    static update<T, U>(MyModel: CrudModelI, data: UpdateQuery<T>, filter: FilterQuery<U>): Promise<any>;
    /**
     ...
     */
    static getMany<T>(MyModels: CrudModelI, query: typeof request.query, populate: PopulateFieldI | PopulateFieldI[], category?: FilterQuery<T> | null): Promise<any>;
    /**
     ...
     */
    static delete<T>(MyModel: CrudModelI, data: FilterQuery<T>): Promise<any>;
    /**
